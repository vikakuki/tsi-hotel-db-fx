...
public interface WorkerRepository extends JpaRepository<Worker, Long> {
    ...
    public void updateWorker(Long id, Double salary, String position, String login, String name, String surname, Date birthDate, String email, Integer phoneNumber, String password, Integer personalCode);
    ...
    @Transactional
    public void addNewWorker(String login, String password, String position, String name, String surname, Date birthDate, String email, Integer phoneNumber, Double salary, Integer personalCode);
